...
// 	if err := r.store.db.QueryRow("INSERT INTO accounts(user_id, amount, type_acc) VALUES ($1, '0', 'balance') RETURNING id_account",
// 		a.id_user, a.amount, a.type_acc).Scan(&a.id_account); err != nil {
// 		return nil, err
// 	}
